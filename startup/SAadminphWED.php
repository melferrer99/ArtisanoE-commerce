...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadminphWED.php"><button class="btn btn-outline-secondary active" type="button">Wedding</button></a>
 ...
 <!-- input upload --> 
 <form method="POST" action="SAadminphWED.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($resultWedPH)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadminphWED.php?editWED=<?php echo $row['id']; ?>">Edit</a>

          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?del_WED=<?php echo $row['id']; ?>">Delete</a>
