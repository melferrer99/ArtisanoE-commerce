...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="admintrailerWED.php"><button class="btn btn-outline-secondary active" type="button">Wedding</button></a>
 ...
 <!-- input upload --> 
 <form method="POST" action="admintrailerWED.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($result3)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="admintrailerWED.php?editVideoWED=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="processWED.php?delVideoWED=<?php echo $row['id']; ?>">Delete</a>
