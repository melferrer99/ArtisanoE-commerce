...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadmintrailerBD.php"><button class="btn btn-outline-secondary active" type="button">Birthday</button></a>
  ...
  <!-- input upload --> 
 <form method="POST" action="SAadmintrailerBD.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($result2)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadmintrailerBD.php?editVideoBD=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocessBD.php?delVideoBD=<?php echo $row['id']; ?>">Delete</a>
