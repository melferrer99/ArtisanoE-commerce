...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="adminphotoRE.php"><button class="btn btn-outline-secondary active" type="button">Reunion</button></a>
 ...
 <form method="POST" action="adminphotoRE.php" enctype="multipart/form-data">
  ...
  <table>
    <thead>
      ...
      <td>
        ...
        <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="adminphotoRE.php?editRE=<?php echo $row['id']; ?>">Edit</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="process.php?del=<?php echo $row['id']; ?>">Delete</a>
