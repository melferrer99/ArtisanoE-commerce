...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="admintrailerCH.php"><button class="btn btn-outline-secondary active" type="button">Christening</button></a>
 ...
 <!-- input upload --> 
 <form method="POST" action="admintrailerCH.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($resultvidCH)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="admintrailerCH.php?editVideoCH=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="processCH.php?delVideoCH=<?php echo $row['id']; ?>">Delete</a>
