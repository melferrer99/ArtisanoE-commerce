...
<div class="sidebar" style="background-color: white;">
  ...
  <a href="SApackagesadmin.php" style="color: white; background-color: lightgray;"><img src="img/package.png" style="width:30px;height:30px; margin-right: 10%;">Packages</a>
...
<form method="POST" action="SApackagesadmin.php" enctype="multipart/form-data">
  ...
  <div class="col-sm-6" style="background-color: white; margin: 2%; border-radius: 2%;">
    ...
    <div class="form-group" style="margin-top: 2%;">
          ...
          <div class="col-sm-8" style="margin-top: 1%;">
            <input class="form-control" type="text" name="p_category" value="<?= $p_category;?>" autocomplete="off"></div>
  ...
  <table>
    <thead>
      ...
      <td>
           ...
           <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SApackagesadmin.php?editPACKAGE=<?php echo $row['id']; ?>">Edit</a>


          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?del_package=<?php echo $row['id']; ?>">Delete</a>
