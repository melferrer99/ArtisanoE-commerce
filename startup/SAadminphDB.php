...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadminphDB.php"><button class="btn btn-outline-secondary active" type="button">Debut</button></a>
    <hr>
  </div>


 <!-- input upload --> 
 <form method="POST" action="SAadminphDB.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($resultDBPH)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadminphDB.php?editDB=<?php echo $row['id']; ?>">Edit</a>

          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?del_DB=<?php echo $row['id']; ?>">Delete</a>
