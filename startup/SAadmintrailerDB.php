<?php include 'SAprocessDB.php';


if (isset($_GET['editVideoDB'])) {
    $id = $_GET['editVideoDB'];
    
    $edit_state = true;

    $rec = mysqli_query($con, "SELECT * FROM tbl_debutvideos WHERE id=$id");
...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadmintrailerRE.php"><button class="btn btn-outline-secondary" type="button">Reunion</button></a>
      ...
      <a href="SAadmintrailerDB.php"><button class="btn btn-outline-secondary active" type="button">Debut</button></a>
    <hr>
  </div>


 <!-- input upload --> 
 <form method="POST" action="SAadmintrailerDB.php" enctype="multipart/form-data">
<div class="col-lg-4" style="background-color: lightgray; padding: 1%; border-radius: 10px;">
  ...
  <form class="md-form" action="#">
    <div class="file-field" >
      ...
      <input type="text" required="" name="video_text" class="form-control" placeholder="Video name" input type="text" value="<?= $video_text;?>">
  ...
  <div class="input-group" style="margin-top: 5px;">
        ...
        <?php else: ?>
         <button class="btn btn-outline-secondary btn-block  btn-success" type="submit" name="updateDBvid" style="border: solid 1px;">Update</button>
        <?php endif ?>
      </div>
...
<div class="col-sm-12"><hr></div>
 ...
 <?php while ($row = mysqli_fetch_array($result4)):?>
  ...
  <table>
    <thead>
      <td>
        <tr><video style="width: 300px; height: 250px" controls="mouse-over"><?php echo "<source src='debutvideos/".$row['videos']."' >"; ?></video></tr>
        <tr><?php echo "<p>" .$row['video_text']."</p>"; ?></tr>
      </td>
      <td>
         <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadmintrailerDB.php?editVideoDB=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocessDB.php?delVideoDB=<?php echo $row['id']; ?>">Delete</a>
