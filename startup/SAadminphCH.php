...
<div class="col-sm-12" style="text-align: center; font-size: 2em;">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
     ...
     <a href="SAadminphotoRE.php"><button class="btn btn-outline-secondary" type="button">Reunion</button></a>
      <a href="SAadminphCH.php"><button class="btn btn-outline-secondary active" type="button">Christening</button></a>
      <a href="SAadminphWED.php"><button class="btn btn-outline-secondary" type="button">Wedding</button></a>
      <a href="SASAadminphBD.php"><button class="btn btn-outline-secondary" type="button">Birthday</button></a>
 ...
 <!-- input upload --> 
  <form method="POST" action="SAadminphCH.php" enctype="multipart/form-data">
  ...
  <table>
    <thead>
      ...
      <td>
         ...
         <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadminphCH.php?editCH=<?php echo $row['id']; ?>">Edit</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?del_CH=<?php echo $row['id']; ?>">Delete</a>
