...
<div class="container" style="margin-left: 15%;">
  <div class="col-sm-12" style="text-align: center; font-size: 2em; margin-bottom: 1%;">
...
$view_querys = mysqli_query($connection,"SELECT * FROM tbl_reservation");
  ...
  <tr>
    ...
    <td>
          ...
          <a  class="btn btn-success" onclick="javascript:confirmationApprove($(this));return false;" href="process.php?approval=<?php echo $row['r_id']; ?>" >Approve</a>
