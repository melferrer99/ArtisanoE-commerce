...
<?php
 ...
 if (isset($_POST['updateRE'])) {
  ...
  mysqli_query($db, "UPDATE tbl_reunionphotos SET image_text='$image_text', image='$image' WHERE id = $id");
...
<?php
 ...
 // Create database connection
  ...
  mysqli_query($db, "UPDATE tbl_christeningphotos SET image_textCH='$image_textCH', imageCH='$imageCH' WHERE id = $id");
  $_SESSION['msg'] = "Address updated";
  header('location: adminphCH.php');
}
...
<?php
 ...
 // Create database connection
  ...
  mysqli_query($db, "UPDATE tbl_weddingphotos SET image_textWED='$image_textWED', imageWED='$imageWED' WHERE id = $id");
  $_SESSION['msg'] = "Address updated";
  header('location: adminphWED.php');
}
...
<?php
 ...
 // Create database connection
  ...
  mysqli_query($db, "UPDATE tbl_birthdayphotos SET image_textBD='$image_textBD', imageBD='$imageBD' WHERE id = $id");
  $_SESSION['msg'] = "Address updated";
  header('location: adminphBD.php');
}
...
<?php
 ...
 // Create database connection
  ...
  mysqli_query($db, "UPDATE tbl_debutphotos SET image_textDB='$image_textDB', imageDB='$imageDB' WHERE id = $id");
  $_SESSION['msg'] = "Address updated";
  header('location: adminphDB.php');
}
...
<?php 
  ...
  $_SESSION['msg'] = "Address updated";
  header('location: packagesadmin.php');
}
