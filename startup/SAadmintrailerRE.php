...
if (isset($_GET['editVideoRE'])) {
    $id = $_GET['editVideoRE'];
    
    $edit_state = true;
    
    $rec = mysqli_query($con, "SELECT * FROM tbl_reunionvideos WHERE id=$id");
...
<div class="sidebar">
 ...
 <a href="SuperAdmin.php" style="color: gray;"><img src="img/dashboard.png" style="width:30px;height:30px; margin-right: 10%;">Dashboard</a>
  ...
  <a href="SAadmintrailerRE.php" style="color: white; background-color: lightgray;"><img src="img/trailer.png" style="width:30px;height:30px; margin-right: 10%;">Videos</a>
...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadmintrailerRE.php"><button class="btn btn-outline-secondary active" type="button">Reunion</button></a>
      <a href="SAadmintrailerCH.php"><button class="btn btn-outline-secondary" type="button">Christening</button></a>
      <a href="SAadmintrailerWED.php"><button class="btn btn-outline-secondary" type="button">Wedding</button></a>
      <a href="SAadmintrailerBD.php"><button class="btn btn-outline-secondary" type="button">Birthday</button></a>
      <a href="SAadmintrailerDB.php"><button class="btn btn-outline-secondary" type="button">Debut</button></a>
    <hr>
  </div>


 <!-- input upload --> 
 <form method="POST" action="SAadmintrailerRE.php" enctype="multipart/form-data">
<div class="col-lg-4" style="background-color: lightgray; padding: 1%; border-radius: 10px;">
  ...
  <form class="md-form" action="#" >
    <div class="file-field" >
      ...
      <div class="btn btn-outline-white btn-rounded waves-effect" >
        <input type="file" multiple name="videos" value="<?= $videos;?>">
      </div>
  ...
  <div class="input-group" style="margin-top: 5px;">
        ...
        <button class="btn btn-outline-secondary btn-block" type="submit" name="Upload_videoRE" style="border: solid 1px;">Upload</button>
        <?php else: ?>
         <button class="btn btn-outline-secondary btn-block  btn-success" type="submit" name="updateREvid" style="border: solid 1px;">Update</button>
        <?php endif ?>
      </div>
...
<div class="col-sm-12"><hr></div>
 ...
 <?php while ($row = mysqli_fetch_array($resultVidRE)):?>
  ...
  <table>
    <thead>
      <td>
        <tr><video style="width: 300px; height: 250px" controls="mouse-over"><?php echo "<source src='reunionvideos/".$row['videos']."' >"; ?></video></tr>
        <tr><?php echo "<p>" .$row['video_text']."</p>"; ?></tr>
      </td>
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadmintrailerRE.php?editVideoRE=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?delVideoRE=<?php echo $row['id']; ?>">Delete</a>
