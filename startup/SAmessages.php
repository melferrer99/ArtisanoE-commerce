...
<div class="sidebar">
 ...
 <form method="POST" action="SAprocess.php" enctype="multipart/form-data">
...
<div class="col-sm-12" style="text-align: center; margin-top: 1%;">
  <a href="SAmessages.php"><button class="btn btn-outline-secondary active" type="button">Pending</button></a>
      <a href="SAmessagesApprove.php"><button class="btn btn-outline-secondary" type="button">Approved</button></a>

  <a href="export1.php?export=true" type="submit" name="export" class="btn btn-success" style="float: right;" >EXPORT</a>
</div>
...
$view_querys = mysqli_query($connection,"SELECT * FROM tbl_reservation");
  ...
  <tr>
    ...
    <td>
          ...
          <a  class="btn btn-success" onclick="javascript:confirmationApprove($(this));return false;" href="SAprocess.php?approval=<?php echo $row['r_id']; ?>" >Approve</a>
       ...
       <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocess.php?del_message=<?php echo $row['r_id']; ?>">Delete</a>
