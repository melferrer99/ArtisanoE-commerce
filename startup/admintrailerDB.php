 ...
 <?php while ($row = mysqli_fetch_array($result4)):?>
  ...
  <table>
    <thead>
      ...
      <td>
         <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="admintrailerDB.php?editVideoDB=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="processDB.php?delVideoDB=<?php echo $row['id']; ?>">Delete</a>
