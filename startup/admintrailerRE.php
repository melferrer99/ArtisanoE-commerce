...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="admintrailerRE.php"><button class="btn btn-outline-secondary active" type="button">Reunion</button></a>
 ...
 <!-- input upload --> 
 <form method="POST" action="admintrailerRE.php" enctype="multipart/form-data">
 ...
 <?php while ($row = mysqli_fetch_array($resultVidRE)):?>
  ...
  <table>
    <thead>
      ...
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="admintrailerRE.php?editVideoRE=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="process.php?delVideoRE=<?php echo $row['id']; ?>">Delete</a>
