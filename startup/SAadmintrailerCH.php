<?php include('SAprocessCH.php');


if (isset($_GET['editVideoCH'])) {
    $id = $_GET['editVideoCH'];
    
    $edit_state = true;

    $rec = mysqli_query($con, "SELECT * FROM tbl_christeningvideos WHERE id=$id");
...
<div class="content">
  ...
  <div class="menu" style="text-align: center; padding-bottom: 1%;">
      ...
      <a href="SAadmintrailerCH.php"><button class="btn btn-outline-secondary active" type="button">Christening</button></a>
 ...
 <!-- input upload --> 
 <form method="POST" action="SAadmintrailerCH.php" enctype="multipart/form-data">
<div class="col-lg-4" style="background-color: lightgray; padding: 1%; border-radius: 10px;">
 ...
 <div class="input-group" style="margin-top: 5px;">
        ...
        <?php else: ?>
         <button class="btn btn-outline-secondary btn-block  btn-success" type="submit" name="updateCHvid" style="border: solid 1px;">Update</button>
        <?php endif ?>
      </div>
...
<div class="col-sm-12"><hr></div>
 ...
 <?php while ($row = mysqli_fetch_array($resultvidCH)):?>
  <div class="gallery col-sm-6" style="text-align: center;">
  <table>
    <thead>
      <td>
        <tr><video style="width: 300px; height: 250px" controls="mouse-over"><?php echo "<source src='christeningvideos/".$row['videos']."' >"; ?></video></tr>
        <tr><?php echo "<p>" .$row['video_text']."</p>"; ?></tr>
      </td>
      <td>
          <a class="edit_btn btn btn-success" onclick="javascript:confirmationEdit($(this));return false;" href="SAadmintrailerCH.php?editVideoCH=<?php echo $row['id']; ?>">Rename</a>

          
          <a class="del_btn btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="SAprocessCH.php?delVideoCH=<?php echo $row['id']; ?>">Delete</a>
